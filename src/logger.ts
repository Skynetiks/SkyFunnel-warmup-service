...
probableCauses: ${info.probableCauses?.join(', ')}
================================================================================
    `),
);
...
const consoleFormat = winston.format.combine(
    ...
    winston.format.printf((info: Info) => `${info.timestamp} [${info.level}]: ${info.message}`),
);
...
class Logger {
    // Base log method
    private static log(level: LEVELS, message: string, context?: Record<string, unknown>, probableCauses?: string[]): void {
        const logMessage = {
            message,
            context,
            probableCauses,
    ...
    static info(message: string, context?: Record<string, unknown>, probableCauses?: string[]): void {
        this.log('info', message, context, probableCauses);
    }

    // Static method for error logging
    static error(message: string, context?: Record<string, unknown>, probableCauses?: string[]): void {
    ...
    static criticalError(message: string, context?: Record<string, unknown>, probableCauses?: string[]): void {
    ...
    static warn(message: string, context?: Record<string, unknown>, probableCauses?: string[]): void {
